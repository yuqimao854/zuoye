...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR><input type=hidden name=sid value=<%=request.getParameter("id")%>><input type=hidden name=title value=<%=title%>>
          <TD width=45% align=right>菜品名称：</TD><TD align=left><%=title %></TD> 
		</TR> 
		<TR>
          <TD width=45% align=right>订购数量：</TD><TD align=left><input type=text name=rs ></TD>
		</TR>
		<TR>
          <TD  align=right>送货时间：</TD><TD align=left><input type=text name=sj  ></TD>
		</TR>
		<TR>
          <TD  align=right>送货地点：</TD><TD align=left><input type=text name=ts  ></TD>
		</TR>
		<TR>
