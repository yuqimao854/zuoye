...
//-->
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
		  ...
		  <TD align=left><br>
		  菜品名称：<%=hotlist.get(1).toString()%> <br>
		  销售价格：<%=hotlist.get(3).toString()%>  &nbsp;&nbsp;&nbsp;主要原料：<%=hotlist.get(4).toString()%><br>
		  菜肴味型：<%=hotlist.get(5).toString()%>  <br> 
		  菜肴菜式：<%=hotlist.get(6).toString()%> <br>
		  发布时间：<%=hotlist.get(8).toString()%><br>
		  <a href="<%=basePath%>prepinfo.jsp?id=<%=id%>&title=<%=hotlist.get(1).toString()%>">我要订购该菜肴</a> （如果您还没有登录，请先登录再进行订购操作！）
		  </TD>
		</TR>
		<TR>
