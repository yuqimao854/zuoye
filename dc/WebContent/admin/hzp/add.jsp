...
<%} %>
  ...
  <tr bgcolor='#FFFFFF'> <input type="hidden" name="method" value="<%=method %>"> <input type="hidden" name="id" value="<%=id %>">
    <td width='30%'><div align="right">菜品名称：</div></td>
  ...
  <tr bgcolor='#FFFFFF'>  
    ...
    <td ><input name="dz" type="text" id="dz" size="15" maxlength="100" value="<%=dz %>"  onkeyup="if(!(/^[\d]+\.?\d*$/.test(this.value))){alert('您的输入有误');this.value='';this.focus();}"> 元</td>
  </tr>
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">主要原料：</div></td>
    <td ><input name="yb" type="text" id="yb" size="40" maxlength="100" value="<%=yb %>"></td>
  </tr>
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">菜肴味型：</div></td>
    <td ><input name="dh" type="text" id="dh" size="40" maxlength="100" value="<%=dh %>"> </TD>
  </tr>
  <tr bgcolor='#FFFFFF'> 
    <td width='30%'><div align="right">菜肴菜式：</div></td>
