...
function top(){
   	form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%><%=dir %>/hzp/index.jsp?page="+page;
      form3.submit();
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     ...
     <td width="5%" align="center">ID </td>
      ...
      <td  align="center">主要原料</td>
      <td  align="center">菜肴味型</td>
      <td  align="center">菜肴菜式</td>
    ...
    <%
    		tb.setEVERYPAGENUM(12);
			int cou = tb.getMessageCount();//得到信息总数			        
			...
			List pagelist1 = tb.getMessage(Integer.parseInt(page1));
			session.setAttribute("qqq", pagelist1);
			int pageCount = tb.getPageCount(); //得到页数  
	...
	<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
      ...
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=tb.gegXsl(pagelist2.get(1).toString()) %></td>
      <td align="center" bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><%=tb.gegXsl(pagelist2.get(1).toString())*Float.parseFloat(pagelist2.get(3).toString()) %></td>
